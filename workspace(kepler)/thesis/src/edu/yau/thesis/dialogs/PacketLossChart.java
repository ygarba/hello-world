...
import edu.yau.thesis.dialogs.FitnessChart.AnotherChartPanel;

public class PacketLossChart extends JPanel implements IObserver {
    ...
    public PacketLossChart() {
    	...
    	try {
			logFileStream = new PrintStream(new File("packet_loss.log"));
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
		 "Packet Loss Plot", 				// Title
		 "Count", 					// x-axis Label
		 "packet loss", 					// y-axis Label
		 ds, 						// Dataset
    ...
    private XYSeriesCollection createDataset() {
    	...
    	dataXY = new XYSeries("packet loss");
    ...
    @Override
    public void updateFitness(double x, double y) {}	//not needed here since we have two lines to plot
