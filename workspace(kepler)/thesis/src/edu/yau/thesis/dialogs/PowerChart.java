...
public class PowerChart extends JPanel implements IObserver {
    ...
    public PowerChart() {
    	...
    	try {
			logFileStream = new PrintStream(new File("power.log"));
