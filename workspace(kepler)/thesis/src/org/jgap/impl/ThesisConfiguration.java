...
public class ThesisConfiguration
   ...
   * @since 1.0
   */
  public ThesisConfiguration(String a_id, String a_name) {
    super(a_id, a_name);
    try {
      ...
      addGeneticOperator(new MutationOperator(this, 20));	//5, 10, 20, 100 (0.2, 0.1, 0.05, 0.01)
    }
